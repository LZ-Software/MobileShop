...
USER_PERMISSIONS = {
    ...
    permissions.USER_COUNTRY_ACCESS: True,
    permissions.USER_COUNTRY_READ: True,
    permissions.USER_CITY_ACCESS: True,
    permissions.USER_CITY_READ: True,
...
PUBLISHER_MANAGER_PERMISSIONS = {
    permissions.PUBLISHER_ACCESS: True,
    permissions.PUBLISHER_AUTHENTICATION_ACCESS: True,
    permissions.PUBLISHER_IMAGES_CREATE: True,
    permissions.PUBLISHER_IMAGES_READ: True,
    permissions.PUBLISHER_IMAGES_UPDATE: True,
    permissions.PUBLISHER_USER_LOGIN_ACCESS: True,
    permissions.PUBLISHER_USER_LOGIN_READ: True,
    permissions.PUBLISHER_USER_LOGIN_UPDATE: True,
    permissions.PUBLISHER_USER_INFO_ACCESS: True,
    permissions.PUBLISHER_USER_INFO_READ: True,
    permissions.PUBLISHER_USER_INFO_UPDATE: True,
    permissions.PUBLISHER_USER_LIBRARY_ACCESS: True,
    permissions.PUBLISHER_USER_LIBRARY_CREATE: True,
    permissions.PUBLISHER_USER_LIBRARY_READ: True,
    permissions.PUBLISHER_ROLE_ACCESS: True,
    permissions.PUBLISHER_ROLE_READ: True,
    permissions.PUBLISHER_GAME_ACCESS: True,
    permissions.PUBLISHER_GAME_READ: True,
    permissions.PUBLISHER_PUBLISHER_ACCESS: True,
    permissions.PUBLISHER_PUBLISHER_READ: True,
    permissions.PUBLISHER_PUBLISHER_UPDATE: True,
    permissions.PUBLISHER_GENRE_ACCESS: True,
    permissions.PUBLISHER_GENRE_READ: True,
    permissions.PUBLISHER_GAME_GENRE_ACCESS: True,
    permissions.PUBLISHER_GAME_GENRE_READ: True,
    permissions.PUBLISHER_COUNTRY_ACCESS: True,
    permissions.PUBLISHER_COUNTRY_READ: True,
    permissions.PUBLISHER_CITY_ACCESS: True,
    permissions.PUBLISHER_CITY_READ: True,
    permissions.PUBLISHER_GAME_PURCHASE_ACCESS: True,
    permissions.PUBLISHER_GAME_PURCHASE_CREATE: True,
    permissions.PUBLISHER_GAME_PURCHASE_READ: True,
    permissions.PUBLISHER_USER_ROLE_ACCESS: True,
    permissions.PUBLISHER_USER_ROLE_READ: True,
}
